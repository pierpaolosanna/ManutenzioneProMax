...
# ============================================================
# BLOCCO 2 - UI COLORI E VARIABILI GLOBALI
# ============================================================
...
# ============================================================
# BLOCCO 3 - FUNZIONI UTILITY DI BASE
# ============================================================
...
# ============================================================
# BLOCCO 14 - COSTRUZIONE GUI CON MENU A TENDINA (COMPLETO)
# ============================================================
function Build-GUI {
...
$adminBadge.Location = New-Object System.Drawing.Point(240, 10)
if($isAdmin) { 
...
$comboCategory.Location = New-Object System.Drawing.Point(420, 5)
$comboCategory.Size = New-Object System.Drawing.Size(200, 24)
...
$verLabel.Font = New-Object System.Drawing.Font("Segoe UI", 6.5)
$verLabel.ForeColor = $fgDim
$verLabel.AutoSize = $true
$verLabel.Location = New-Object System.Drawing.Point(960, 10)
...
$script:logBox.Add_TextChanged({
    $script:logBox.SelectAll()
    $script:logBox.SelectionAlignment = [System.Windows.Forms.HorizontalAlignment]::Center
    $script:logBox.SelectionIndent = 30
    $script:logBox.SelectionHangingIndent = 0
    $script:logBox.SelectionRightIndent = 30
...
$script:form.Add_Shown({
    ...
    Log " Log: $logFile"; Log ""
    if(-not $isAdmin) { Log " [!] Utente standard. 'Eleva Admin' per sbloccare tutto."; Log "" }
    Flush-LogBuffer
})
